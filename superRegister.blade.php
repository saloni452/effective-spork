        ...
        <div class="col-md-6">
          <div class="card mx-4">
            <div class="card-body p-4">
                <form method="POST" action="/superRegistration">
                    @csrf
                    <h1>{{ __('Super Register') }}</h1>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">
                            <svg class="c-icon">
                              <use xlink:href="assets/icons/coreui/free-symbol-defs.svg#cui-expand-down"></use>
                            </svg>
                          </span>
                        </div>
                        <div class="col-md-6">
                    ...
                    <!-- <button class="btn btn-block btn-danger" type="button">{{ __('Login') }}</button> -->
                    <div class="col-6 text-right">
                        <a href="{{ route('superLogin') }}" class="btn btn-link px-0">{{ __('Already Registered? Login') }}</a>
                    </div>
                </form>
            </div>
